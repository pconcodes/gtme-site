...
export function ClickHouseLeadForm() {
    ...
    return (
      ...
      >
        ...
        <p className="mt-3 leading-7" style={{ color: c.muted }}>
          ...
          ClickHouse, and a reply from me is already on its way.
        </p>
        <button
          type="button"
    ...
    <form onSubmit={handleSubmit} className="space-y-5" noValidate>
      ...
      <div>
        ...
        <input
          ...
          placeholder="you@clickhouse.com"
        />
      </div>
      ...
      <button
        ...
        className="w-full rounded-lg px-5 py-3 text-sm font-semibold transition-opacity hover:opacity-85 disabled:opacity-60"
        style={{ backgroundColor: c.yellow, color: c.bg }}
      >
