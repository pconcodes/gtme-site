    ...
    return (
      ...
      >
        ...
        <p className="mt-3 leading-7" style={{ color: c.muted }}>
          ...
          Bolt, and a reply from me is already on its way.
        </p>
        <button
          type="button"
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5" noValidate>
      ...
      <button
        ...
        className="w-full rounded-xl px-5 py-3 text-sm font-semibold transition-opacity hover:opacity-85 disabled:opacity-60"
